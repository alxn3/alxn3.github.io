...
const Home = () => {
  return (
    <BaseLayout
      headerContent={
        <div className="flex flex-col items-center justify-around h-full md:justify-center md:py-10">
          <div className="flex flex-col-reverse items-center justify-center md:flex-row-reverse md:flex-1 md:space-x-10 md:pb-40">
